...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Jun 21 00:54:45 CEST 2015
  */
      ...
      switch (CUP$SqlCup$act_num)
		...
		String var2 = (String)((java_cup.runtime.Symbol) CUP$SqlCup$stack.elementAt(CUP$SqlCup$top-1)).value;
          ...
          case 17: // var_type ::= VARCHAR LBRACKET INTEGER RBRACKET 
            {
              Object RESULT =null;
		int valleft = ((java_cup.runtime.Symbol)CUP$SqlCup$stack.elementAt(CUP$SqlCup$top-1)).left;
		int valright = ((java_cup.runtime.Symbol)CUP$SqlCup$stack.elementAt(CUP$SqlCup$top-1)).right;
		Object val = (Object)((java_cup.runtime.Symbol) CUP$SqlCup$stack.elementAt(CUP$SqlCup$top-1)).value;
          ...
          case 16: // var_type ::= VARCHAR LBRACKET INTEGER RBRACKET key 
            {
              Object RESULT =null;
		int valleft = ((java_cup.runtime.Symbol)CUP$SqlCup$stack.elementAt(CUP$SqlCup$top-2)).left;
		int valright = ((java_cup.runtime.Symbol)CUP$SqlCup$stack.elementAt(CUP$SqlCup$top-2)).right;
		Object val = (Object)((java_cup.runtime.Symbol) CUP$SqlCup$stack.elementAt(CUP$SqlCup$top-2)).value;
		...
		String var = (String)((java_cup.runtime.Symbol) CUP$SqlCup$stack.elementAt(CUP$SqlCup$top-1)).value;
		 parser.nazwa=var.toString(); parser.tab.getAtrybuty().put(parser.nazwa,"test type"); 
