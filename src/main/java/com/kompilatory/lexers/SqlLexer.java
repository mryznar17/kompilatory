/* The following code was generated by JFlex 1.4.3 on 13.06.15 18:11 */
 ...
 * on 13.06.15 18:11 from the specification file
 * <tt>C:/Users/Marek/workspace/sqlToEntity/src/main/java/com/kompilatory/lexers/sql.flex</tt>
 */
public final class SqlLexer extends DefaultJFlexLexer implements java_cup.runtime.Scanner {
   ...
   * @exception   java.io.IOException  if any I/O-Error occurs
   */
  public Token next_token2() throws java.io.IOException {
    int zzInput;
    int zzAction;
  ...
  public static void main(String argv[]) {
    if (argv.length == 0) {
      System.out.println("Usage : java SqlLexer <inputfile>");
    }
    else {
      for (int i = 0; i < argv.length; i++) {
        SqlLexer scanner = null;
        try {
          scanner = new SqlLexer( new java.io.FileReader(argv[i]) );
